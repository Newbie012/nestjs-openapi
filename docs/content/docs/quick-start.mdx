---
title: Quick Start
seoTitle: 'Quick start: generate an OpenAPI spec from NestJS'
description: 'Generate your first OpenAPI spec from a NestJS app in three steps: write a config file, point it at your root module, and run the CLI.'
icon: Zap
---
