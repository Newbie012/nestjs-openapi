---
title: Errors
seoTitle: 'Error classes'
description: 'Reference for the typed error classes nestjs-openapi throws, including ConfigNotFoundError, ConfigLoadError and ConfigValidationError, and how to handle them.'
---
