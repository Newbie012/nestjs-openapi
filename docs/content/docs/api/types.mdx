---
title: Types
seoTitle: 'TypeScript types'
description: 'Reference for the public TypeScript types of nestjs-openapi, including Config, GenerateResult and the OpenAPI spec types.'
---
...
- [Spec Validation](/docs/api/spec-validation) - Validation utilities
