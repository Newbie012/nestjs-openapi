---
title: OpenApiModule
seoTitle: 'OpenApiModule API reference'
description: 'Reference for OpenApiModule, the NestJS module that serves a generated OpenAPI spec and optional Swagger UI at runtime.'
---
