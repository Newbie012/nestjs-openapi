---
title: generate()
seoTitle: 'generate() API reference'
description: 'Reference for generate(), the function that reads a NestJS app from a config path and writes an OpenAPI spec in JSON or YAML.'
---
