...
seoTitle: 'Validate OpenAPI specs for broken $ref links'
description: 'Reference for validateSpec(), which finds $ref targets missing from an OpenAPI spec. The CLI runs it automatically and reports warnings.'
---
