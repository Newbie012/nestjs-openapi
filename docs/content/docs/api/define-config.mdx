---
title: defineConfig()
seoTitle: 'defineConfig() API reference'
description: 'Reference for defineConfig(), the typed helper for nestjs-openapi config files. Enables autocomplete and type checking for your openapi.config.ts.'
---
