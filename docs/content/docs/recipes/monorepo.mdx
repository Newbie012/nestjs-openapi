...
seoTitle: 'OpenAPI specs for a NestJS monorepo'
description: 'Generate a separate OpenAPI spec for each NestJS app in a monorepo with one config file per app.'
---
