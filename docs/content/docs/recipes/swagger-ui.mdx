---
title: Swagger UI
seoTitle: 'Serve Swagger UI for a NestJS OpenAPI spec'
description: 'Serve interactive Swagger UI for a NestJS app from the generated spec, with OpenApiModule or a static setup.'
---
