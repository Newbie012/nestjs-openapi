...
seoTitle: 'Generate OpenAPI specs in CI'
description: 'Generate and check OpenAPI specs in GitHub Actions and other CI pipelines. No running app, database or environment variables needed.'
---
