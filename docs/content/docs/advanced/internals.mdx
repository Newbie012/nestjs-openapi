---
title: Internals
seoTitle: 'How generation works internally'
description: 'How nestjs-openapi turns NestJS source into an OpenAPI spec: config loading, AST parsing with ts-morph, module traversal and schema generation.'
---
