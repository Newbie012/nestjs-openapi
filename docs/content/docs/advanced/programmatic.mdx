...
seoTitle: 'Programmatic API'
description: 'Call generate() from build scripts, tests and custom tooling to produce OpenAPI specs from NestJS code without the CLI.'
---
