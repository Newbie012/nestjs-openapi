---
title: Effect-TS API
seoTitle: 'Effect-TS API'
description: 'Call nestjs-openapi from Effect-TS code for typed errors, composable pipelines and resource-safe spec generation.'
---

nestjs-openapi uses [Effect-TS](https://effect.website/) internally. If you already use Effect in your project, you can use the library's Effect-based API directly for typed error handling.
