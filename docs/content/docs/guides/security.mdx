---
title: Security
seoTitle: 'Security schemes and auth'
description: 'Define bearer, API key, OAuth2 and other security schemes in config, and apply them globally or per operation with NestJS security decorators.'
---
