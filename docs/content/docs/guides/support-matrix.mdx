...
seoTitle: 'Support matrix'
description: 'What nestjs-openapi supports today: routing decorators, parameters, request bodies, responses, security and versioning, with notes on each.'
---
