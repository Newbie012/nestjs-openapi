---
title: Filtering
seoTitle: 'Exclude endpoints from the OpenAPI spec'
description: 'Exclude endpoints and controllers from a generated OpenAPI spec with @ApiExcludeEndpoint, @ApiExcludeController or path filters in config.'
---
