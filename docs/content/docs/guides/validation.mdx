---
title: Validation
seoTitle: 'class-validator to OpenAPI schema constraints'
description: 'Turn class-validator decorators such as @MinLength, @Max and @IsOptional into OpenAPI schema constraints automatically, and see what is not covered.'
---
