---
title: Comparison
seoTitle: 'nestjs-openapi vs @nestjs/swagger'
description: 'Side-by-side OpenAPI output for unions, generics, literal types and nullable fields, generated from the same TypeScript by nestjs-openapi and @nestjs/swagger.'
icon: Scale
---
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div>
    <div className="text-sm font-medium text-green-600 dark:text-green-400 mb-2">nestjs-openapi</div>
